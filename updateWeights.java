...
/*
 * This class is used to update the weights of the perceptron.
 */

class updateWeights 
{
	//This method updates the weights if the expected output and the actual output are not the same.
